...
function MusAudioControl(_audioContext, _bufferSize, _references, _conditions, _errorHandler, _randomize, _createHiddenReferences, _restartForReference) {
    this.audioContext = _audioContext;
    this.bufferSize = parseInt(_bufferSize);
    this.references = _references;
    this.conditions = _conditions;    
    this.errorHandler = _errorHandler;
    this.restartForReference = _restartForReference;
    ...
    // store initial order (we may sort later)
    for (let i = 0; i < this.conditions.length; ++i) {
      this.conditions[i].initIndex = i;
    }
  ...
  MusAudioControl.prototype.playReference = function(_index) {
    if (this.restartForReference == true) {
        this.setPosition(this.audioLoopStart);
    }
  ...
  MusAudioControl.prototype.playCondition = function(_index) {
    if (this.restartForReference == true && this.audioIsReferencePlaying == true) {
      this.setPosition(this.audioLoopStart);
    }
  ...
  MusAudioControl.prototype.setConditions = function(_conditions) {
    this.conditions = _conditions;
  };
  ...
  MusAudioControl.prototype.getReferenceIndexOfConditions = function() {
    // TODO: this just finds the first of j references in conditions
