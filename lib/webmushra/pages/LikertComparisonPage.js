function LikertComparisonPage(_reference, _condition, _pageManager, _pageTemplateRenderer, _audioContext, _bufferSize, _audioFileLoader, _session, _pageConfig, _errorHandler, _language) {
...
LikertComparisonPage.prototype.init = function () {
    ...
    this.likert = new LikertScale(this.pageConfig.response, "timbral_quality", likertDisabledOnStart, this.likertCallback);
}
