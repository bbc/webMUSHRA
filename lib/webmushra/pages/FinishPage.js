...
FinishPage.prototype.render = function (_parent) {
  ...
  var table = $("<table align='center' style='width:50%'></table>");
  ...
  for (i = 0; i < this.pageConfig.questionnaire.length; ++i) {
    ...
    if (element.type === "text") {
      table.append($("<tr><td style='width:40%'><strong>" + element.label + "</strong></td><td style='padding-left:100px; padding-right:100px'><input id='" + element.name + "' /></td></tr>"));
    } else if (element.type === "number") {
      table.append($("<tr><td style='width:40%; padding-top:30px'><strong>" + element.label + "</strong></td><td style='padding-top:30px; padding-left:100px; padding-right:100px'><input id='" + element.name + "' min='" + element.min + "' max='" + element.max + "' value='" + element.default + "' data-inline='true'/></td></tr>"));
      ...
      table.append($("<tr><td colspan='2' style='padding-left:200px; padding-right:200px'><textarea name='" + element.name + "' id='" + element.name + "'></textarea></td></tr>"));
