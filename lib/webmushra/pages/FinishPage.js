...
FinishPage.prototype.render = function (_parent) {
  ...
  for (i = 0; i < this.pageConfig.questionnaire.length; ++i) {
    ...
    if (element.type === "text") {
      ...
      table.append($("<tr><td style='width:50%'><strong>" + element.label + "</strong></td><td style='padding-left:150px; padding-right:150px; width:50%'><input id='" + element.name + "' min='" + element.min + "' max='" + element.max + "' value='" + element.default + "' data-inline='true'/></td></tr>"));
