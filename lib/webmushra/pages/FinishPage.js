...
FinishPage.prototype.render = function (_parent) {
  ...
  for (i = 0; i < this.pageConfig.questionnaire.length; ++i) {
    ...
    if (element.type === "text") {
      table.append($("<tr><td style='width:50%'><strong>" + element.label + "</strong></td><td style='width:50%; padding-left:100px; padding-right:100px'><input id='" + element.name + "' /></td></tr>"));
    } else if (element.type === "number") {
      table.append($("<tr><td style='width:50%'><strong>" + element.label + "</strong></td><td style='padding-left:300px; padding-right:300px; width:50%'><input id='" + element.name + "' min='" + element.min + "' max='" + element.max + "' value='" + element.default + "' data-inline='true'/></td></tr>"));
      ...
      table.append($("<tr><td colspan='2' style='padding-left:400px; padding-right:400px'><textarea name='" + element.name + "' id='" + element.name + "'></textarea></td></tr>"));
    } else if (element.type === "checkboxes") {
      var tr = $("<tr></tr>");
      var td = $("<td style='padding-left:40px; padding-right:50px'><strong>" + element.label + "</strong></td>");
      var td2 = $("<td style='padding-left:300px'></td>");
      ...
      table.append($("<tr><td style='padding-top:30px' colspan=2 id=" + element.name + " style='vertical-align:top; padding-top:" + $('#feedback').css('margin-top') + "'><br><strong>" + element.label + "</strong><br>" + element.content + "<br><br></td></tr>"));
    }
    console.log(element);
  }
  ...
  $("#popHeader").text(this.pageManager.getLocalizer().getFragment(this.language, 'participating'));
