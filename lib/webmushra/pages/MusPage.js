...
MusPage.prototype.render = function (_parent) {
  ...
  var tdExtraContent = $("<td id='tdExtraContent' align = 'center'></td>");
  // TODO: allow an image per reference?
  ...
  trMushra.append(tdExtraContent);
...
MusPage.prototype.renderCanvas = function (_parentId) {
  ...
  var xDrawingStart =
    refColSpace + canvasContext.measureText("100 ").width * 1.5;
  var xAbsTableOffset =
...
MusPage.prototype.save = function () {
  ...
  this.loop.start = parseInt(
    this.musAudioControl.audioLoopStart
  );
  this.loop.end = parseInt(
    this.musAudioControl.audioLoopEnd
  );
};
