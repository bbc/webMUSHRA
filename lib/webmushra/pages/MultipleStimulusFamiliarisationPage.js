...
function MultipleStimulusFamiliarisationPage(
  ...
  this.macic = null;
  this.hasReference = typeof(this.pageConfig.reference) !== "undefined";
...
MultipleStimulusFamiliarisationPage.prototype.init = function () {
  ...
  this.mushraValidator.checkNumChannels(this.audioContext, this.hasReference? this.reference : this.conditions[0]);
  var i;
  ...
  this.mushraValidator.checkConditionConsistency(
    this.hasReference? this.reference : this.conditions[0],
    this.conditions
  );
  ...
  this.mushraAudioControl = new MushraAudioControl(
    ...
    this.pageConfig.createHiddenReference
  );
