function BBCSpatialReferencePage(
  _reference,
  _pageManager,
  ...
  this.pageConfig.name = this.pageConfig.name + " - Reference";
  this.pageConfig.content =
    "Please indicate the perceived spatial characteristics of the reference condition.<br/>" +
    "Use the scale on the left-hand-side to indicate the height, relative to ear level.<br/>" +
    "Use the radar display on the right-hand-side to indicate the azimuth (horizontal direction), distance, and width.";
 ...
 */
BBCSpatialReferencePage.prototype.getName = function () {
 ...
 */
BBCSpatialReferencePage.prototype.init = function () {
...
BBCSpatialReferencePage.prototype.initMUSHRAController = function () {
...
BBCSpatialReferencePage.prototype.initUI = function () {
 ...
 */
BBCSpatialReferencePage.prototype.render = function (_parent) {
  var div = $("<div></div>");
  _parent.append(div);
  ...
  tdSH.innerHTML =
    "<h3>Height</h3>Use the left mouse button to indicate the perceived source height.";
  trRatingHeading.appendChild(tdSH);

  var tdRH = document.createElement("td");
  tdRH.innerHTML =
    "<h3>Azimuth, Distance, and Width</h3>Use the primary mouse button to indicate the perceived source azimuth and distance.<br/>Use the secondary mouse button to indicate the perceived source width (dragging up to increase it and down to decrease it).";
...
BBCSpatialReferencePage.prototype.setLoopStart = function () {
...
BBCSpatialReferencePage.prototype.setLoopEnd = function () {
  var slider = document.getElementById("slider");
...
BBCSpatialReferencePage.prototype.pause = function () {
  this.mushraAudioControl.pause();
};

BBCSpatialReferencePage.prototype.btnCallbackReference = function () {
...
BBCSpatialReferencePage.prototype.cleanButtons = function () {
 ...
 */
BBCSpatialReferencePage.prototype.load = function () {
 ...
 */
BBCSpatialReferencePage.prototype.save = function () {
...
BBCSpatialReferencePage.prototype.store = function () {
